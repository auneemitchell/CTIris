...
export const STIX_RELATIONSHIP_DESCRIPTIONS: Record<string, string> = {
  ...
  "beacons-to": "Says the malware beacons to the related Infrastructure, maintaining a persistent C2 channel.",
  "exfiltrates-to": "Says the malware sends stolen data to the related Infrastructure.",
  ...
  "downloads": "Says this malware downloads another piece of malware, a tool, or a file from a remote source.",
  "drops": "Says this malware or tool drops another piece of malware or a file onto the system.",
  ...
  "owns": "Says the Intrusion Set owns the related Infrastructure.",
