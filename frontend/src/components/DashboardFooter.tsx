...
export default function DashboardFooter({ setTab }: Props) {
                ...
                <Box sx={{ px: {xs: 1, md: 12}, width: { xs: '100%', md: '70%', justifyContent: 'center' } }}>
                    <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, alignItems: { xs: 'center', sm: 'flex-start' }, gap: 1, flexShrink: 1}}>
                        <Box sx={{ display: 'flex', flexDirection: 'column', textAlign: 'center', px: { xs: 2, md: 4 }, flex: 1 }}>
                            ...
                            <Typography variant="body2" sx={{ color: COLORS.textPrimary, p: 1, cursor: 'pointer' }} onClick={() => setTab(0)}> Dashboard </Typography>
                            <Typography variant="body2" sx={{ color: COLORS.textPrimary, p: 1, cursor: 'pointer' }} onClick={() => setTab(1)}> Feeds </Typography>
                            <Typography variant="body2" sx={{ color: COLORS.textPrimary, p: 1, cursor: 'pointer' }} onClick={() => setTab(2)}> Stix Objects </Typography>
                        </Box>
                        <Box sx={{ display: 'flex', flexDirection: 'column', textAlign: 'center', px: { xs: 2, md: 4 }, flex: 1 }}>
